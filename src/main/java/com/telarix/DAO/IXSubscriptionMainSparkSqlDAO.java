...
public class IXSubscriptionMainSparkSqlDAO extends SparkSqlDAOBase {
	

	private String driver;
	private String dbUrl;
	
	private	final static Logger logger = Logger.getLogger(IXSubscriptionMainSparkSqlDAO.class);
