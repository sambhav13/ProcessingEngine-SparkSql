...
public class IXControl_ClientDAO {

	private DataSource dataSource;
	private JdbcTemplate jdbcTemplateObject;
	
	private	final static Logger logger = Logger.getLogger(IXControl_ClientDAO.class);
	
	public IXControl_ClientDAO(DataSource dataSource) {
		super();
	...
	public void executeProcedure(String proc_Name)
	{
		...
		logger.info("The Procedure "+proc_Name+" on IXControl_ClientDAO was executed !!");
		System.out.println("The Procedure "+proc_Name+" on IXControl_ClientDAO was executed !!");
	...
	public void executeSql(String sql)
	{
		...
		logger.info("Sql Executed on IXControl_ClientDAO: "+sql);
